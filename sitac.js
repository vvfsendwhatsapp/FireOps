...
function avvia(app){
  ...
  const L10N_EXTRA = {
    ...
    en:{ bCono:'Add cone',
      ...
      bPosizionePronta:'Position available',
      bPosizioneFatta:'Coordinates acquired',
      conoModo:'How should the cone be built?',
      ...
      vento_debole:'Light wind', vento_moderato:'Moderate wind', vento_forte:'Strong wind',
      ...
      p1:'Incident', p2:'Local wind', p3:'Origin and area involved',
      p4:'Propagation cones', p5:'Operating area', p6:'Fire progression',
      p7:'Deployed means', p8:'Actions', p9:'Edit', p10:'Import and export',
      nDos:'WIC ID', dosAiuto:'Four characters, digits or letters. E.g. VF 12A4',
      posDos:'WIC position',
      posComeQuale:'How do you set the WIC position?',
      posGps:'GPS location', posGpsNota:'Reads where this device is.',
      posCoord:'Enter the coordinates', posCoordNota:'Decimal degrees, comma separated.',
      posMappa:'Click on the map', posMappaNota:'One click where the WIC stands.',
      posClicMappa:'Click the WIC position on the map.',
      chiediCoord:'Coordinates: latitude, longitude in decimal degrees',
      coordErrate:'Invalid coordinates.',
      provincia:'Province', comando:'Competent Command',
      geoLeggo:'Looking up the province\u2026',
      geoErrore:'Province not determined: {e}',
      geoFatto:'WIC in the province of {p}.',
      bVentoDir:'Direction on the map', bVentoWeb:'Read from Open-Meteo',
      ventoTrascina:'Drag the arrow head: it shows where the wind is GOING.',
      ventoNoDos:'Set the WIC position at step 1 first.',
      ventoNota:'A weather service estimate does not see slope wind: correct it by eye.',
      ventoImpostato:'Wind {v} km/h towards {d}\u00b0 ({f}).',
      statoDispositivo:'State of the deployment', statoAzioni:'State of the actions',
      bSfondo:'Map: {n}',
      p2Nota:'This reads where this device is: in the control room that is not where the WIC stands.',
      pFatto:'\u2713', pManca:'to do',
      ...
      dosPosa:'Place the WIC symbol here', dosSposta:'Move the WIC here',
      dosSolo:'Keep the coordinates only', dosPosato:'WIC placed on the acquired position.',
      conoElemento:'From an area or a front already drawn',
      conoElementoNota:'From a burned area the downwind edge is taken; from a front, the line itself.',
      conoNienteBase:'No burned area or front on the map: draw one, or use the other modes.',
      conoScegliBase:'Click the area or the front the cone should start from.',
      conoBaseCorta:'The chosen geometry has too few vertices.',
      lancioManiglie:'Drag the tip for direction and length, the side for width, the centre to move it.',
      lancioDi:'Axis {a} m · width {b} m · {s} ha',
      ventoQuale:'Which wind should it be built with?',
      ventoRiusa:'Scenario wind — {v} km/h towards {d}\u00b0',
      ventoRiusaNota:'The one set at step 2 ({f}).',
      ventoAltro:'A different local wind',
      ventoAltroNota:'For this cone only: the scenario data is unchanged.',
      rilLeggo:'Reading the terrain\u2026',
      rilErrore:'Terrain unavailable: {e} — cone not corrected.',
      rilFatto:'Radii corrected for slope: {k}\nEmpirical estimate, not SI.TA.C.',
      posRilevataQ:'Position acquired: {lat}, {lon}\nIs this the WIC position?',
      posRilevataSi:'Yes, it is the WIC position',
      posRilevataSiNota:'Place the symbol here and fill in the step 1 field.',
      posRilevataNo:'No, I will set it another way',
      posRilevataNoNota:'Coordinates passed by radio, or a click on the map.',
      supPercorsa:'Burned: {v} ha',
      supAttiva:'Active fire: {v} ha',
      supTotale:'Total involved: {v} ha',
      ventoRiancorato:'WIC position changed.\nThe wind arrow has been re-anchored: check the direction.',
      ...
      cartaBloccata:'Validate the step 1 data to use the map.',
      popPosTit:'WIC position', popPosOk:'Confirm', popPosSposta:'Move',
      posAnnullata:'Position selection cancelled.',
      redatta:'Drawn',
      bPulisciDati:'Clear fields',
      confPulisciDati:'Empty every incident field?\nThe drawing on the map is untouched.',
      datiPuliti:'Fields cleared.',
      menuSposta:'Move', menuElimina:'Delete',
      menuVertici:'Edit the vertices', menuTesto:'Edit the label',
      menuDirezione:'Change direction', menuManiglie:'Edit footprint',
      menuStato:'Mark as {s}', menuCono:'Cone {n}',
      menuVerticiOn:'Vertices editable.\nDrag the handles, Esc to finish.',
      menuSpostaPunto:'Drag the symbol where you need it.',
      menuSpostaArea:'Drag the whole geometry.\nEsc to finish.',
      lanciChiedi:'Drops by air means',
      lanciNota:'Leave blank whatever did not take part: only what dropped appears on the sheet.',
      lanciTot:'Total drops', stampaAnnullata:'Printing cancelled.',
      lancioPosato:'Drop placed.\u000aSelect it, or right-click, to adjust its footprint.',
      menuMisure:'Measurements',
      scegliLato:'Pick the side: click on the map towards where\u000athe arrows should point.',
      latoScelto:'Side set.\u000aRight-click on the line to change it.',
      menuLato:'Change side',
      ventoTit:'Local wind',
      menuVentoDir:'Change direction',
      menuVentoInt:'Change speed',
      ventoClicDir:'Click on the map in the direction the wind is GOING.',
      ventoBloccato:'The wind arrow cannot be dragged.\u000aRight-click for direction and speed.',
      legVento:'Wind direction \u2014 {v} km/h towards {d}\u00b0',
      chiediNotaLibera:'Note',
      notaAggiunta:'Note added.',
      bAggiungiNota:'Add note',
      disegnoAnnullato:'Drawing cancelled: too few vertices.',
      chiediPaese:'Country of the module',
      menuPaese:'Change country',
      stSquadre:'Ground deployment \u2014 planned and active crews',
      dirSegui:'\u25b6 Move the pointer: the symbol turns.\u000aSecond click sets the direction.',
      p8note:'Notes', bNotePulisci:'Clear the notes',
      noteAiuto:'What used to be written by hand in the margin: times, names, whatever has no symbol.',
      stNote:'Notes',
      datiOkAuto:'Data complete: validated automatically \u2014 incident {i}, {n}.\u000aTab 2 is unlocked.', },
    fr:{ bCono:'Ajouter un c\u00f4ne',
      bPosizione:'Saisir les coordonnées',
      bPosizionePronta:'Position disponible',
      bPosizioneFatta:'Coordonnées relevées',
      conoModo:'Comment construire le c\u00f4ne ?',
      ...
      vento_debole:'Vent faible', vento_moderato:'Vent mod\u00e9r\u00e9', vento_forte:'Vent fort',
      ...
      p1:'Intervention', p2:'Vent local', p3:'Origine et surface concern\u00e9e',
      p4:'C\u00f4nes de propagation', p5:'Zone d\u2019intervention', p6:'\u00c9volution de l\u2019incendie',
      p7:'Dispositif d\u2019intervention', p8:'Actions', p9:'Modifier', p10:'Importer et exporter',
      nDos:'ID COS', dosAiuto:'Quatre caract\u00e8res, chiffres ou lettres. Ex. VF 12A4',
      posDos:'Position du COS',
      posComeQuale:'Comment indiquez-vous la position du COS ?',
      posGps:'Localisation GPS', posGpsNota:'Lit o\u00f9 se trouve cet appareil.',
      posCoord:'Saisir les coordonn\u00e9es', posCoordNota:'Degr\u00e9s d\u00e9cimaux, s\u00e9par\u00e9s par une virgule.',
      posMappa:'Clic sur la carte', posMappaNota:'Un clic o\u00f9 se trouve le COS.',
      posClicMappa:'Cliquez la position du COS sur la carte.',
      chiediCoord:'Coordonn\u00e9es : latitude, longitude en degr\u00e9s d\u00e9cimaux',
      coordErrate:'Coordonn\u00e9es invalides.',
      provincia:'Province', comando:'Commandement comp\u00e9tent',
      geoLeggo:'Recherche de la province en cours\u2026',
      geoErrore:'Province non d\u00e9termin\u00e9e : {e}',
      geoFatto:'COS dans la province de {p}.',
      bVentoDir:'Direction sur la carte', bVentoWeb:'Lire depuis Open-Meteo',
      ventoTrascina:'D\u00e9placez la pointe de la fl\u00e8che : elle indique o\u00f9 VA le vent.',
      ventoNoDos:'Indiquez d\u2019abord la position du COS \u00e0 l\u2019\u00e9tape 1.',
      ventoNota:'L\u2019estimation d\u2019un service m\u00e9t\u00e9o ne voit pas le vent de versant : corrigez-la \u00e0 vue.',
      ventoImpostato:'Vent {v} km/h vers {d}\u00b0 ({f}).',
      statoDispositivo:'\u00c9tat du dispositif', statoAzioni:'\u00c9tat des actions',
      bSfondo:'Carte : {n}',
      p2Nota:'Le relev\u00e9 donne la position de cet appareil : en salle op\u00e9rationnelle ce n\u2019est pas celle du COS.',
      ...
      dosPosa:'Poser ici le symbole COS', dosSposta:'D\u00e9placer le COS ici',
      dosSolo:'Garder seulement les coordonn\u00e9es', dosPosato:'COS pos\u00e9 sur la position relev\u00e9e.',
      conoElemento:'Depuis une zone ou un front d\u00e9j\u00e0 trac\u00e9s',
      conoElementoNota:'D\u2019une surface parcourue on prend le bord sous le vent ; d\u2019un front, le trac\u00e9.',
      conoNienteBase:'Aucune surface parcourue ni front sur la carte : tracez-en un, ou utilisez les autres modes.',
      conoScegliBase:'Cliquez la zone ou le front d\u2019o\u00f9 doit partir le c\u00f4ne.',
      conoBaseCorta:'La g\u00e9om\u00e9trie choisie a trop peu de sommets.',
      lancioManiglie:'D\u00e9placez la pointe pour la direction et la longueur, le flanc pour la largeur, le centre pour le d\u00e9placer.',
      lancioDi:'Axe {a} m · largeur {b} m · {s} ha',
      ventoQuale:'Avec quel vent le construire ?',
      ventoRiusa:'Vent du sc\u00e9nario — {v} km/h vers {d}\u00b0',
      ventoRiusaNota:'Celui d\u00e9fini \u00e0 l\u2019\u00e9tape 2 ({f}).',
      ventoAltro:'Un vent local diff\u00e9rent',
      ventoAltroNota:'Vaut pour ce c\u00f4ne seulement : le sc\u00e9nario ne change pas.',
      rilLeggo:'Lecture du relief en cours\u2026',
      rilErrore:'Relief indisponible : {e} — c\u00f4ne non corrig\u00e9.',
      rilFatto:'Rayons corrig\u00e9s pour la pente : {k}\nEstimation empirique, non SI.TA.C.',
      posRilevataQ:'Position relev\u00e9e : {lat}, {lon}\nEst-ce la position du COS ?',
      posRilevataSi:'Oui, c\u2019est la position du COS',
      posRilevataSiNota:'Posez ici le symbole et remplissez le champ de l\u2019\u00e9tape 1.',
      posRilevataNo:'Non, je l\u2019indique autrement',
      posRilevataNoNota:'Coordonn\u00e9es dict\u00e9es par radio, ou un clic sur la carte.',
      supPercorsa:'Parcourue : {v} ha',
      supAttiva:'En feu actif : {v} ha',
      supTotale:'Concern\u00e9e au total : {v} ha',
      ventoRiancorato:'Position du COS modifi\u00e9e.\nLa fl\u00e8che du vent a \u00e9t\u00e9 r\u00e9ancr\u00e9e : v\u00e9rifiez la direction.',
      ...
      cartaBloccata:'Validez les donn\u00e9es de l\u2019\u00e9tape 1 pour utiliser la carte.',
      popPosTit:'Position du COS', popPosOk:'Valider', popPosSposta:'D\u00e9placer',
      posAnnullata:'Choix de la position annul\u00e9.',
      redatta:'\u00c9tablie',
      bPulisciDati:'Vider les champs',
      confPulisciDati:'Vider tous les champs de l\u2019intervention ?\nLe dessin sur la carte n\u2019est pas touch\u00e9.',
      datiPuliti:'Champs vid\u00e9s.',
      menuSposta:'D\u00e9placer', menuElimina:'Supprimer',
      menuVertici:'Modifier les sommets', menuTesto:'Modifier le texte',
      menuDirezione:'Changer la direction', menuManiglie:'Modifier l\u2019emprise',
      menuStato:'Marquer comme {s}', menuCono:'C\u00f4ne {n}',
      menuVerticiOn:'Sommets modifiables.\nD\u00e9placez les poign\u00e9es, \u00c9chap pour finir.',
      menuSpostaPunto:'D\u00e9placez le symbole o\u00f9 il faut.',
      menuSpostaArea:'D\u00e9placez toute la g\u00e9om\u00e9trie.\n\u00c9chap pour finir.',
      lanciChiedi:'Largages du dispositif a\u00e9rien',
      lanciNota:'Laissez vide ce qui n\u2019est pas intervenu : seul ce qui a largu\u00e9 figure sur la feuille.',
      lanciTot:'Total des largages', stampaAnnullata:'Impression annul\u00e9e.',
      lancioPosato:'Largage pos\u00e9.\u000aS\u00e9lectionnez-le, ou clic droit, pour r\u00e9gler son emprise.',
      menuMisure:'Mesures',
      scegliLato:'Choisissez le c\u00f4t\u00e9 : cliquez sur la carte du c\u00f4t\u00e9 vers lequel\u000avont les fl\u00e8ches.',
      latoScelto:'C\u00f4t\u00e9 d\u00e9fini.\u000aClic droit sur le trac\u00e9 pour le changer.',
      menuLato:'Changer de c\u00f4t\u00e9',
      ventoTit:'Vent local',
      menuVentoDir:'Modifier la direction',
      menuVentoInt:'Modifier l\u2019intensit\u00e9',
      ventoClicDir:'Cliquez sur la carte dans la direction o\u00f9 VA le vent.',
      ventoBloccato:'La fl\u00e8che du vent ne se d\u00e9place pas.\u000aClic droit pour direction et intensit\u00e9.',
      legVento:'Direction du vent \u2014 {v} km/h vers {d}\u00b0',
      chiediNotaLibera:'Note',
      notaAggiunta:'Note ajout\u00e9e.',
      bAggiungiNota:'Ajouter une note',
      disegnoAnnullato:'Dessin annul\u00e9 : trop peu de sommets.',
      chiediPaese:'Nation du module',
      menuPaese:'Changer de nation',
      stSquadre:'Dispositif au sol \u2014 \u00e9quipes pr\u00e9vues et en cours',
      dirSegui:'\u25b6 D\u00e9placez le pointeur : le symbole tourne.\u000aSecond clic pour fixer la direction.',
      p8note:'Notes', bNotePulisci:'Vider les notes',
      noteAiuto:'Ce qu\u2019on \u00e9crivait \u00e0 la main dans la marge : horaires, noms, tout ce qui n\u2019a pas de symbole.',
      stNote:'Notes',
      datiOkAuto:'Donn\u00e9es compl\u00e8tes : valid\u00e9es d\u2019elles-m\u00eames \u2014 intervention {i}, {n}.\u000aL\u2019onglet 2 est d\u00e9bloqu\u00e9.', },
    es:{ bCono:'A\u00f1adir cono',
      bPosizione:'Introducir coordenadas',
      bPosizionePronta:'Posici\u00f3n disponible',
      bPosizioneFatta:'Coordenadas obtenidas',
      conoModo:'\u00bfC\u00f3mo se construye el cono?',
      ...
      vento_debole:'Viento d\u00e9bil', vento_moderato:'Viento moderado', vento_forte:'Viento fuerte',
      ...
      p1:'Intervenci\u00f3n', p2:'Viento local', p3:'Origen y superficie afectada',
      p4:'Conos de propagaci\u00f3n', p5:'Zona de intervenci\u00f3n', p6:'Evoluci\u00f3n del incendio',
      p7:'Dispositivo de intervenci\u00f3n', p8:'Acciones', p9:'Editar', p10:'Importar y exportar',
      nDos:'ID DOE', dosAiuto:'Cuatro caracteres, cifras o letras. P. ej. VF 12A4',
      posDos:'Posici\u00f3n del DOE',
      posComeQuale:'\u00bfC\u00f3mo indicas la posici\u00f3n del DOE?',
      posGps:'Localizaci\u00f3n GPS', posGpsNota:'Lee d\u00f3nde est\u00e1 este dispositivo.',
      posCoord:'Introducir las coordenadas', posCoordNota:'Grados decimales, separados por coma.',
      posMappa:'Clic en el mapa', posMappaNota:'Un clic donde est\u00e1 el DOE.',
      posClicMappa:'Haz clic en el mapa en la posici\u00f3n del DOE.',
      chiediCoord:'Coordenadas: latitud, longitud en grados decimales',
      coordErrate:'Coordenadas no v\u00e1lidas.',
      provincia:'Provincia', comando:'Mando competente',
      geoLeggo:'Buscando la provincia\u2026',
      geoErrore:'Provincia no determinada: {e}',
      geoFatto:'DOE en la provincia de {p}.',
      bVentoDir:'Direcci\u00f3n en el mapa', bVentoWeb:'Leer de Open-Meteo',
      ventoTrascina:'Arrastra la punta de la flecha: indica hacia d\u00f3nde VA el viento.',
      ventoNoDos:'Indica primero la posici\u00f3n del DOE en el paso 1.',
      ventoNota:'La estimaci\u00f3n del servicio meteorol\u00f3gico no ve el viento de ladera: corr\u00edgela a ojo.',
      ventoImpostato:'Viento {v} km/h hacia {d}\u00b0 ({f}).',
      statoDispositivo:'Estado del dispositivo', statoAzioni:'Estado de las acciones',
      bSfondo:'Mapa: {n}',
      p2Nota:'La medici\u00f3n da la posici\u00f3n de este dispositivo: en sala no es la del DOE.',
      ...
      dosPosa:'Coloca aqu\u00ed el s\u00edmbolo DOE', dosSposta:'Mueve aqu\u00ed el DOE',
      dosSolo:'Conserva solo las coordenadas', dosPosato:'DOE colocado en la posici\u00f3n obtenida.',
      conoElemento:'Desde un \u00e1rea o un frente ya dibujados',
      conoElementoNota:'De una superficie quemada se toma el borde a sotavento; de un frente, el trazado.',
      conoNienteBase:'Ninguna superficie quemada ni frente en el mapa: dibuja uno, o usa los otros modos.',
      conoScegliBase:'Haz clic en el \u00e1rea o el frente desde el que parte el cono.',
      conoBaseCorta:'La geometr\u00eda elegida tiene muy pocos v\u00e9rtices.',
      lancioManiglie:'Arrastra la punta para direcci\u00f3n y longitud, el lateral para la anchura, el centro para moverlo.',
      lancioDi:'Eje {a} m · anchura {b} m · {s} ha',
      ventoQuale:'\u00bfCon qu\u00e9 viento se construye?',
      ventoRiusa:'Viento del escenario — {v} km/h hacia {d}\u00b0',
      ventoRiusaNota:'El definido en el paso 2 ({f}).',
      ventoAltro:'Un viento local distinto',
      ventoAltroNota:'Vale solo para este cono: el escenario no cambia.',
      rilLeggo:'Leyendo el relieve\u2026',
      rilErrore:'Relieve no disponible: {e} — cono sin corregir.',
      rilFatto:'Radios corregidos por pendiente: {k}\nEstimaci\u00f3n emp\u00edrica, no SI.TA.C.',
      posRilevataQ:'Posici\u00f3n obtenida: {lat}, {lon}\n\u00bfEs esta la posici\u00f3n del DOE?',
      posRilevataSi:'S\u00ed, es la posici\u00f3n del DOE',
      posRilevataSiNota:'Coloca aqu\u00ed el s\u00edmbolo y rellena el campo del paso 1.',
      posRilevataNo:'No, la indico de otro modo',
      posRilevataNoNota:'Coordenadas dictadas por radio, o un clic en el mapa.',
      supPercorsa:'Quemada: {v} ha',
      supAttiva:'Con fuego activo: {v} ha',
      supTotale:'Afectada en total: {v} ha',
      ventoRiancorato:'Posici\u00f3n del DOE modificada.\nLa flecha del viento se ha reanclado: verifica la direcci\u00f3n.',
      ...
      cartaBloccata:'Valida los datos del paso 1 para usar el mapa.',
      popPosTit:'Posici\u00f3n del DOE', popPosOk:'Validar', popPosSposta:'Mover',
      posAnnullata:'Elecci\u00f3n de la posici\u00f3n cancelada.',
      redatta:'Redactada',
      bPulisciDati:'Vaciar campos',
      confPulisciDati:'\u00bfVaciar todos los campos de la intervenci\u00f3n?\nEl dibujo del mapa no se toca.',
      datiPuliti:'Campos vaciados.',
      menuSposta:'Mover', menuElimina:'Eliminar',
      menuVertici:'Editar los v\u00e9rtices', menuTesto:'Editar el texto',
      menuDirezione:'Cambiar direcci\u00f3n', menuManiglie:'Editar la extensi\u00f3n',
      menuStato:'Marcar como {s}', menuCono:'Cono {n}',
      menuVerticiOn:'V\u00e9rtices editables.\nArrastra los tiradores, Esc para terminar.',
      menuSpostaPunto:'Arrastra el s\u00edmbolo donde haga falta.',
      menuSpostaArea:'Arrastra toda la geometr\u00eda.\nEsc para terminar.',
      lanciChiedi:'Descargas de los medios a\u00e9reos',
      lanciNota:'Deja vac\u00edo lo que no ha intervenido: en la hoja aparece solo quien ha descargado.',
      lanciTot:'Total de descargas', stampaAnnullata:'Impresi\u00f3n cancelada.',
      lancioPosato:'Descarga colocada.\u000aSelecci\u00f3nala, o bot\u00f3n derecho, para ajustar su extensi\u00f3n.',
      menuMisure:'Medidas',
      scegliLato:'Elige el lado: haz clic en el mapa hacia donde\u000aapuntan las flechas.',
      latoScelto:'Lado definido.\u000aBot\u00f3n derecho sobre el trazado para cambiarlo.',
      menuLato:'Cambiar de lado',
      ventoTit:'Viento local',
      menuVentoDir:'Modificar la direcci\u00f3n',
      menuVentoInt:'Modificar la intensidad',
      ventoClicDir:'Haz clic en el mapa hacia donde VA el viento.',
      ventoBloccato:'La flecha del viento no se arrastra.\u000aBot\u00f3n derecho para direcci\u00f3n e intensidad.',
      legVento:'Direcci\u00f3n del viento \u2014 {v} km/h hacia {d}\u00b0',
      chiediNotaLibera:'Nota',
      notaAggiunta:'Nota a\u00f1adida.',
      bAggiungiNota:'A\u00f1adir nota',
      disegnoAnnullato:'Dibujo cancelado: muy pocos v\u00e9rtices.',
      chiediPaese:'Naci\u00f3n del m\u00f3dulo',
      menuPaese:'Cambiar de naci\u00f3n',
      stSquadre:'Dispositivo terrestre \u2014 equipos previstos y activos',
      dirSegui:'\u25b6 Mueve el puntero: el s\u00edmbolo gira.\u000aSegundo clic para fijar la direcci\u00f3n.',
      p8note:'Notas', bNotePulisci:'Vaciar las notas',
      noteAiuto:'Lo que se escrib\u00eda a mano en el margen: horas, nombres, lo que no tiene s\u00edmbolo.',
      stNote:'Notas',
