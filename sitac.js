...
function avvia(app){
  ...
  const L10N = {
    ...
    en:{
      ...
      nIntervento:'Incident no.', nDos:'DOS', dosAiuto:'Digits or letters, up to six. E.g. VF 12A4',
    ...
    fr:{
      ...
      nIntervento:'N° d\'intervention', nDos:'DOS', dosAiuto:'Chiffres ou lettres, jusqu\u2019à six. Ex. VF 12A4',
    ...
    es:{
      ...
      nIntervento:'N.º de intervención', nDos:'DOS', dosAiuto:'Cifras o letras, hasta seis. P. ej. VF 12A4',
  ...
  const L10N_EXTRA = {
    ...
    en:{ bCono:'Add cone',
      ...
      nDos:'DOS ID', dosAiuto:'Four characters, digits or letters. E.g. VF 12A4',
      posDos:'DOS position',
      posComeQuale:'How do you set the DOS position?',
      ...
      posMappa:'Click on the map', posMappaNota:'One click where the DOS stands.',
      posClicMappa:'Click the DOS position on the map.',
      ...
      geoFatto:'DOS in the province of {p}.',
      ...
      ventoNoDos:'Set the DOS position at step 1 first.',
      ...
      posRilevataQ:'Position acquired: {lat}, {lon}\nIs this the DOS position?',
      posRilevataSi:'Yes, it is the DOS position',
      ...
      posBloccata:'Fill in incident, rank, name, DOS ID and phone first.',
    ...
    fr:{ bCono:'Ajouter un c\u00f4ne',
      ...
      nDos:'ID DOS', dosAiuto:'Quatre caract\u00e8res, chiffres ou lettres. Ex. VF 12A4',
      posDos:'Position du DOS',
      posComeQuale:'Comment indiquez-vous la position du DOS ?',
      ...
      posMappa:'Clic sur la carte', posMappaNota:'Un clic o\u00f9 se trouve le DOS.',
      posClicMappa:'Cliquez la position du DOS sur la carte.',
      ...
      geoFatto:'DOS dans la province de {p}.',
      ...
      ventoNoDos:'Indiquez d\u2019abord la position du DOS \u00e0 l\u2019\u00e9tape 1.',
      ...
      posRilevataQ:'Position relev\u00e9e : {lat}, {lon}\nEst-ce la position du DOS ?',
      posRilevataSi:'Oui, c\u2019est la position du DOS',
      ...
      posBloccata:'Remplissez d\u2019abord intervention, grade, nom, ID DOS et t\u00e9l\u00e9phone.',
    ...
    es:{ bCono:'A\u00f1adir cono',
      ...
      nDos:'ID DOS', dosAiuto:'Cuatro caracteres, cifras o letras. P. ej. VF 12A4',
      posDos:'Posici\u00f3n del DOS',
      posComeQuale:'\u00bfC\u00f3mo indicas la posici\u00f3n del DOS?',
      ...
      posMappa:'Clic en el mapa', posMappaNota:'Un clic donde est\u00e1 el DOS.',
      posClicMappa:'Haz clic en el mapa en la posici\u00f3n del DOS.',
      ...
      geoFatto:'DOS en la provincia de {p}.',
      ...
      ventoNoDos:'Indica primero la posici\u00f3n del DOS en el paso 1.',
      ...
      posRilevataQ:'Posici\u00f3n obtenida: {lat}, {lon}\n\u00bfEs esta la posici\u00f3n del DOS?',
      posRilevataSi:'S\u00ed, es la posici\u00f3n del DOS',
      ...
      posBloccata:'Rellena antes intervenci\u00f3n, categor\u00eda, nombre, ID DOS y tel\u00e9fono.',
